...
curl -o ~/.claude/commands/pptx.md \
  https://raw.githubusercontent.com/fbdeme/claude-pptx-skill/main/commands/pptx.md
```

### Option B — Clone and symlink

```bash
git clone https://github.com/fbdeme/claude-pptx-skill.git
ln -s $(pwd)/claude-pptx-skill/commands/pptx.md ~/.claude/commands/pptx.md
```
